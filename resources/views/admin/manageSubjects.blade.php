...
@section('content')
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($subjects as $i=>$data)
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-label-primary me-1">{{ $data->is_active }}</span></td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <button class="dropdown-item edit-subject" href="javascript:void(0);"
                                                data-id="{{ $data->id }}">
                                                <i class="ti ti-pencil me-1"></i> Edit
                                            </button>
                                            <button class="dropdown-item delete-subject" href="javascript:void(0);"
                                                data-id="{{ $data->id }}">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editHirePlanModalLabel">Add New Subject</h5>
    ...
    <div class="modal fade" id="edit-default-modal" tabindex="-1" aria-labelledby="editSubject" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editHirePlanModalLabel">Edit Subject</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="editSubject" method="PUT" enctype="multipart/form-data">
                        <div class="mb-3">
    ...
    <script>
        $(document).ready(function() {
            $("#insertSubject").submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#insertSubject").trigger("reset");
                        window.open("{{ url('/manage-subject') }}", "_self");
                    },
                    error: function(xhr) {
